...
@media (max-width: 768px) {
    ...
    .st-key-floating_nav {
        ...
        /* هامش آمن يراعي شريط الإيماءات في الأندرويد/الآيفون، ويبقي
           الشريط بعيداً عن ركن أسفل اليمين حيث تظهر شارة Streamlit Cloud
           الخاصة بالمنصة نفسها (خارج نطاق تحكّم كود التطبيق). */
